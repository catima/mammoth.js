...
function DocumentConversion(options, comments) {
    ...
    function convertComment(referencedComment, messages, options) {
        ...
        return [
            Html.freshElement(
                "dt",
                {"id": referentHtmlId("comment", comment.commentId), class: "comment"},
                [Html.text("Comment " + label)]
            ),
            Html.freshElement("dd", {class: "comment"}, body)
        ];
    }
    ...
    var elementConverters = {
        "document": function(document, messages, options) {
            ...
            return children.concat([
                Html.freshElement("ol", {class: "notes"}, notesNodes),
                Html.freshElement("dl", {class: "comments"}, flatMap(referencedComments, function(referencedComment) {
        ...
        "noteReference": function(element, messages, options) {
            ...
            return [Html.freshElement("span", {'data-note-type': element.noteType, 'data-note-id': noteHtmlId(element), class: "note-reference " + element.noteType}, [anchor])];
        },
        "note": function(element, messages, options) {
            var children = convertElements(element.body, messages, options);
            var body = children.concat([]);
            return Html.freshElement("li", {id: noteHtmlId(element), class: "note " + element.noteType}, body);
        },
